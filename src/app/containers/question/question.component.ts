  ...
  allQuestions: QuizQuestion[] = [
    {
      ...
      options: [
        { optionValue: '1', optionText: '@Output()' },
        { optionValue: '2', optionText: '@Input()' },
        { optionValue: '3', optionText: 'Input' },
        { optionValue: '4', optionText: 'Output' }
      ],
      answer: '1',
    ...
    {
      questionId: 2,
      questionText: 'In Angular, you can pass data from the child component to the parent component by using:',
      options: [
        { optionValue: '1', optionText: '@Output()' },
        { optionValue: '2', optionText: '@Input()' },
        { optionValue: '3', optionText: 'Input ' },
